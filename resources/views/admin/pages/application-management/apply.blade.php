    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">All Review Cases</li>
            </ol>
        </div>
        <div class="row">
            <div class="col-sm-12">
                            ...
                            <div class="col-sm-6">
                                <form>
                                    <div class="form-group row">
                                        <label for="telephone_no" class="col-sm-4 col-form-label">Telephone No.</label>

                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="telephone_no">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="application_status" class="col-sm-4 col-form-label">Application Status</label>
                                    ...
                                    <div class="form-group row">
                                        <label for="user_source" class="col-sm-4 col-form-label">User Source</label>

                                        <div class="col-sm-8">
                                            <select id="user_source" class="form-control" disabled>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select id="label" class="form-control" disabled>
                                            </select>
                                        </div>
                                    </div>
