...
Route::get('/', [
    'as' => 'home', 'uses' => 'Demo\PagesController@login2'
]);
...
//    'middleware' => 'admin'
    ...
    Route::get('/application-management/apply', [
        'as' => 'admin.application-management.apply', 'uses' => 'ApplicationManagementController@index'
    ]);

    Route::get('/application-management/component', [
        'as' => 'admin.application-management.component', 'uses' => 'ApplicationManagementController@component'
    ]);

    // Collection Management
    //----------------------------------

    Route::get('/collection-management/case', [
        'as' => 'admin.collection-management.case', 'uses' => 'CollectionManagementController@index'
    ]);
...
Route::group(['middleware' => ['guest']], function () {
    ...
    Route::get('login', [
        'as' => 'login', 'uses' => 'Demo\PagesController@login2'
    ]);
